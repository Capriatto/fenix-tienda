	...
	<body>
		...
		class SampleDashboard extends StandaloneDashboard {
		  ...
		  public function buildDashboard(){
			...
			) t1 RIGHT OUTER JOIN mes am on t1.mdate = am.a_month
			group by am.a_month
			...
			/*echo"<a href='reporte_creditos.php' class='btn btn-config' target='blank'><i class='glyphicon glyphicon-list-alt'></i> Creditos</a>"; echo"


			<a href='reporte_gastos.php' role='button' class='btn btn-config' target='blank'><i class='glyphicon glyphicon-list-alt'></i> Gastos Este Mes</a>"; echo"


			<a href='reporte_diario.php' role='button' class='btn btn-config' target='blank'><i 					class='glyphicon glyphicon-list-alt'></i> Reporte Diario</a>"; */
			...
			if ($sinDatos==false){
				...
				$chart->addSeries ("sales_2014", "Año Actual", array($r_idarray[0], $r_idarray[1], 				   				   $r_idarray[2], $r_idarray[3], $r_idarray[4], $r_idarray[5], $r_idarray[6],$r_idarray[7], 				        $r_idarray[8],  $r_idarray[9], $r_idarray[10], $r_idarray[11]),array("seriesDisplayType"=> "area"
				));
